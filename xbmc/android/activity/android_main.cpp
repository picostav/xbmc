...
extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
  ...
  jclass cMain = env->FindClass("com/pivos/tofu/XBMCBroadcastReceiver");
  if(cMain)
  {
  ...
  jclass cBroadcastReceiver = env->FindClass("com/pivos/tofu/Main");
  if(cBroadcastReceiver)
  {
    static JNINativeMethod sMethods[] =
    {
      {"_onNewIntent",                "(Landroid/content/Intent;)V", (void*)&CJNIContext::_onNewIntent},
      {"_onSystemUiVisibilityChange", "(I)V",                        (void*)&CJNIContext::_onSystemUiVisibilityChange}
    };
    env->RegisterNatives(cBroadcastReceiver, &sMethods[0], sizeof(sMethods)/sizeof(JNINativeMethod));
  }
  return version;
}
